export default function InstructorSidebar({ active, onSelect, open, onClose, isMobile, onLogout }) {
  const items = ['My Courses', 'Lessons', 'Quizzes', 'Assignments', 'Results', 'Profile'];
